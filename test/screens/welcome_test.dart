...
void main() {
  ...
  testWidgets('WelcomeScreen displays the correct images',
    ...
    expect(
        find.byType(Image), findsNWidgets(5)); // Checks for all Image assets.

    // Verify specific image assets.
    expect(
        find.image(const AssetImage('assets/rectAllBlue.png')), findsOneWidget);
    ...
    expect(find.image(const AssetImage('assets/secondBottomRect.png')),
        findsOneWidget);
  });
}
